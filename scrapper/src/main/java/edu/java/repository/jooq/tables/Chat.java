...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.STATUS</code>.
     */
    public final TableField<ChatRecord, Integer> STATUS = createField(DSL.name("STATUS"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.INTEGER)), this, "");
