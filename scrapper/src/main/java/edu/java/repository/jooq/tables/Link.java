...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, Integer> STATUS = createField(DSL.name("STATUS"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.INTEGER)), this, "");
