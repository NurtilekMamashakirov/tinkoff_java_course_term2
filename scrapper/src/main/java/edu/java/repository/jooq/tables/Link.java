...
public class Link extends TableImpl<LinkRecord> {
    ...
    public final TableField<LinkRecord, String> URL =
        createField(DSL.name("URL"), SQLDataType.VARCHAR(200).nullable(false), this, "");
    ...
    public final TableField<LinkRecord, OffsetDateTime> CHECKED_AT =
        createField(DSL.name("CHECKED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");

    /**
     * The column <code>LINK.STATUS</code>.
     */
    public final TableField<LinkRecord, Integer> STATUS = createField(DSL.name("STATUS"),
